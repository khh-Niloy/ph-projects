...
const ModalBtn = ({ modalId, foodId, isClicked, setIsClicked })=>{
    ...
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(__TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContextProvider$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthContext"]);
            ...
            if (isClicked) {
                const fetchData = {
                    "ModalBtn.useEffect.fetchData": async ()=>{
                        const foodData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$getFood$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFood"])(foodId);
                        // setfood(foodData);
...
_s(ModalBtn, "vR/6T65FGqPjWynsMhzBNrbclxo=", false, function() {
    return [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MyFood.useEffect": ()=>{
            async function fetchData() {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/api/foods/my-foods/${user?.email}`);
                const data = await res.data;
                console.log(data);
                setmyFood(data);
            }
...
_s(MyFood, "BaTCHiopuLt/YGre94vchVV1DNo=");
_c = MyFood;

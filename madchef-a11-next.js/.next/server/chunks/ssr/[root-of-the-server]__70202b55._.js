...
async function getRole(email) {
    const res = await axios.post(`${process.env.BASE_URL}/api/role`, {
        email
    });
    return res.data.role; // ✅ match response structure
}
}}),
...
const Navbar = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function fetchRole() {
            const role = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$getRole$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getRole"])(user?.email);
            setRole(role);
        }
        fetchRole();
    }, [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__70202b55._.js.map
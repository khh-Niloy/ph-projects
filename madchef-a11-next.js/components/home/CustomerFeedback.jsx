  ...
  return (
    <div className="w-[100%] lg:w-[65%] mx-auto">
      ...
      <div className="relative">
        ...
        >
          <SwiperSlide>
            <div className="bg-white rounded-2xl p-8 h-full transition-all duration-300 hover:shadow-xl hover:scale-[1.02] border border-gray-100">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex text-amber-400 mt-1">
                      {[...Array(5)].map((_, i) => (
                        <MdOutlineStarPurple500 key={i} className="text-md" />
                      ))}
                    </div>
                  </div>
                </div>
              ...
              <p className="text-gray-600 leading-relaxed text-sm">
                ...
                order. The attention to detail in presentation and taste made
                the whole experience exceptional. Definitely ordering again!
              </p>
            </div>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <div className="bg-white rounded-2xl p-8 h-full transition-all duration-300 hover:shadow-xl hover:scale-[1.02] border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed text-sm">
                ...
                delivery was right on time. Their customer service was also
                exceptional when I had questions. Highly recommend! Definitely ordering again!
              </p>
            </div>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <div className="bg-white rounded-2xl p-8 h-full transition-all duration-300 hover:shadow-xl hover:scale-[1.02] border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed text-sm">
                ...
                care went into preparing this. The ingredients tasted fresh and
                the flavors blended perfectly. Will be a repeat customer!
              </p>
            </div>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <div className="bg-white rounded-2xl p-8 h-full transition-all duration-300 hover:shadow-xl hover:scale-[1.02] border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed text-sm">
                ...
                made it even better. The packaging was eco-friendly and kept
                everything at just the right temperature until I was ready to
                eat.
              </p>
            </div>
          </SwiperSlide>
        ...
        <div className="flex items-center justify-center mt-[5rem]">
          <div className="custom-navigation absolute gap-2 flex z-40 -translate-y-10">
            <FiChevronRight
              ...
              } p-2 text-4xl rounded-2xl rotate-180 custom-prev`}
            >
            ...
            <FiChevronRight
              ...
              className={`cursor-pointer ${
                isDarkMode ? "bg-white text-black" : "bg-black/80 text-white"
              } p-2 text-4xl rounded-2xl custom-next`}
            >
